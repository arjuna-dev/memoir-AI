...
class TestAgentFactory:
    ...
    def test_agent_factory_initialization_defaults(self) -> None:
        ...
        assert factory.default_config.model_name == "openai:gpt-5-nano"
    ...
    def test_native_output_support(
        ...
        factory = AgentFactory()
        agent = factory.create_classification_agent(model_name="openai:gpt-5-nano")

        assert agent == mock_agent
        mock_supports.assert_called_once_with("openai:gpt-5-nano")
...
class TestValidationFunctions:
    ...
    def test_validate_model_name_valid(self) -> None:
        ...
        assert validate_model_name("openai:gpt-5-nano") is True
...
class TestAgentFactoryIntegration:
    ...
    def test_cache_key_uniqueness(self, mock_agent_class) -> None:
        ...
        agent1 = factory.create_classification_agent("openai:gpt-5-nano")
        agent2 = factory.create_classification_agent("anthropic:claude-3")

        # Create agents with different temperatures
        config1 = ModelConfiguration(model_name="openai:gpt-5-nano", temperature=0.0)
        config2 = ModelConfiguration(model_name="openai:gpt-5-nano", temperature=0.5)
